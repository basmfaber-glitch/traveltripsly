...
// Als je Node 18 of hoger gebruikt, hoef je 'node-fetch' niet te installeren.
// Anders: npm install node-fetch en import fetch from 'node-fetch';
export async function getFlights(origin, destination) {
  ...
  try {
    ...
    // We converteren de API data naar iets wat je frontend begrijpt
